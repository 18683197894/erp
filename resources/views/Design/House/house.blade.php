...
<div class="layui-card demand" style="display:none">
  <form class="layui-form layui-form-pane" style="margin: 15px;" lay-filter="demand">
    ...
    <div class="layui-form-item" >
      ...
      <div class="layui-input-block">
        <input name="arrangement" value="" readonly="readonly" lay-verify="required" placeholder="" autocomplete="off" class="layui-input" type="text">
      </div>
    </div>
    <div class="layui-form-item" >
      <label class="layui-form-label" >装修风格</label>
      <div class="layui-input-block">
        <input name="style" value="" readonly="readonly" lay-verify="required" placeholder="" autocomplete="off" class="layui-input" type="text">
      </div>
    </div>
    <div class="layui-form-item layui-form-text" >
      <label class="layui-form-label">喜好</label>
      <div class="layui-input-block">
        <textarea cols="30" rows="2" name="like" readonly="readonly" lay-verify="required" placeholder="" class="layui-textarea"></textarea>
      </div>
    </div>
    <div class="layui-form-item layui-form-text" >
      <label class="layui-form-label">房改需求</label>
      <div class="layui-input-block">
        <textarea cols="30" rows="2" name="demand" readonly="readonly" lay-verify="required" placeholder="" class="layui-textarea"></textarea>
      </div>
    </div>
</form>
</div>
...
<div class="layui-card-body">
	...
	<script type="text/html" id="test-table-toolbar-toolbarDemo">
	  <div class="layui-btn-container">
	    <button class="layui-btn layui-btn-sm" onclick="open_show('新增房号','.add',0.6,0.6)">新增房号</button>
	  </div>
	</script>
  ...
  <script type="text/html" id="demand">
    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="demand">查看需求</a>
  </script>
  ...
  layui.config({
    ...
    table.on('tool(test-table-toolbar)', function(obj){
      ...
      { 
        ...
        open_show('房号'+data.room_number+': 装修需求','.demand',0.6,0.8);
      }else if(obj.event === 'drawing')
      {
        ...
        window.location.href="/design/house/drawing?project_id="+project_id+"&name="+name+"&page="+page+"&limit="+limit+'&house_id='+data.id;
