      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <tr findex="1">
            ...
            <td name="details"></td>
            <td>
              <input class="layui-input" placeholder="开始日" value="{{ isset($schedule[0]->start)?$schedule[0]->start:'' }}" name="start" id="start1">
            </td>
            <td>
              <input class="layui-input" placeholder="截止日" value="{{ isset($schedule[0]->end)? $schedule[0]->end :'' }}" name="end" id="end1">
            </td>
            <td>
          ...
          <tr fid="1">
            ...
            <td name="details"></td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[1]->start)?$schedule[1]->start:'' }}" placeholder="开始日" name="start" id="start2">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[1]->end)? $schedule[1]->end :'' }}" placeholder="截止日" name="end" id="end2">
            </td>
            <td>
          ...
          <tr index="3" fid="1">
            ...
            <td>
              <input class="layui-input" value="{{ isset($schedule[2]->start)?$schedule[2]->start:'' }}" placeholder="开始日" name="start" id="start3">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[2]->end)? $schedule[2]->end :'' }}" placeholder="截止日" name="end" id="end3">
            </td>
            <td>
...
<!-- **************************************************************** -->
          ...
          <tr pid="28" fid="23">
            ...
            <td>
              <input class="layui-input" value="{{ isset($schedule[28]->start)?$schedule[28]->start:'' }}" placeholder="开始日" name="start" id="start29">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[28]->end)? $schedule[28]->end :'' }}" placeholder="截止日" name="end" id="end29">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[28]->liable)?$schedule[28]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[28]->check)?$schedule[28]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr pid="28" fid="23">
            ...
            <td>
              <input class="layui-input" value="{{ isset($schedule[29]->start)?$schedule[29]->start:'' }}" placeholder="开始日" name="start" id="start30">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[29]->end)? $schedule[29]->end :'' }}" placeholder="截止日" name="end" id="end30">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[29]->liable)?$schedule[29]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[29]->check)?$schedule[29]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr index="31" fid="23">
            ...
            <td>
              <input class="layui-input" value="{{ isset($schedule[30]->start)?$schedule[30]->start:'' }}" placeholder="开始日" name="start" id="start31">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[30]->end)? $schedule[30]->end :'' }}" placeholder="截止日" name="end" id="end31">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[30]->liable)?$schedule[30]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[30]->check)?$schedule[30]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr pid="31" fid="23">
            ...
            <td>
              <input class="layui-input" value="{{ isset($schedule[31]->start)?$schedule[31]->start:'' }}" placeholder="开始日" name="start" id="start32">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[31]->end)? $schedule[31]->end :'' }}" placeholder="截止日" name="end" id="end32">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[31]->liable)?$schedule[31]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[31]->check)?$schedule[31]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr pid="31" fid="23">
            ...
            <td>
              <input class="layui-input" value="{{ isset($schedule[32]->start)?$schedule[32]->start:'' }}" placeholder="开始日" name="start" id="start33">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[32]->end)? $schedule[32]->end :'' }}" placeholder="截止日" name="end" id="end33">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[32]->liable)?$schedule[32]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[32]->check)?$schedule[32]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr index="34" fid="23">
            ...
            <td>
              <input class="layui-input" value="{{ isset($schedule[33]->start)?$schedule[33]->start:'' }}" placeholder="开始日" name="start" id="start34">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[33]->end)? $schedule[33]->end :'' }}" placeholder="截止日" name="end" id="end34">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[33]->liable)?$schedule[33]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[33]->check)?$schedule[33]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr pid="35" fid="23">
            ...
            <td>
              <input class="layui-input" value="{{ isset($schedule[34]->start)?$schedule[34]->start:'' }}" placeholder="开始日" name="start" id="start35">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[34]->end)? $schedule[34]->end :'' }}" placeholder="截止日" name="end" id="end35">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[34]->liable)?$schedule[34]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[34]->check)?$schedule[34]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr pid="35" fid="23">
            ...
            <td>
              <input class="layui-input" value="{{ isset($schedule[35]->start)?$schedule[35]->start:'' }}" placeholder="开始日" name="start" id="start36">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[35]->end)? $schedule[35]->end :'' }}" placeholder="截止日" name="end" id="end36">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[35]->liable)?$schedule[35]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[35]->check)?$schedule[35]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
...
************************************************************************************* -->
          ...
          <tr findex="37">
            ...
            <td name="details"></td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[36]->start)?$schedule[36]->start:'' }}" placeholder="开始日" name="start" id="start37">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[36]->end)? $schedule[36]->end :'' }}" placeholder="截止日" name="end" id="end37">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[36]->liable)?$schedule[36]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[36]->check)?$schedule[36]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr fid="37">
            ...
            <td name="details"></td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[37]->start)?$schedule[37]->start:'' }}" placeholder="开始日" name="start" id="start38">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[37]->end)? $schedule[37]->end :'' }}" placeholder="截止日" name="end" id="end38">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[37]->liable)?$schedule[37]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[37]->check)?$schedule[37]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr fid="37">
            ...
            <td name="details"></td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[38]->start)?$schedule[38]->start:'' }}" placeholder="开始日" name="start" id="start39">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[38]->end)? $schedule[38]->end :'' }}" placeholder="截止日" name="end" id="end39">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[38]->liable)?$schedule[38]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[38]->check)?$schedule[38]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
          ...
          <tr fid="37">
            ...
            <td name="details"></td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[39]->start)?$schedule[39]->start:'' }}" placeholder="开始日" name="start" id="start40">
            </td>
            <td>
              <input class="layui-input" value="{{ isset($schedule[39]->end)? $schedule[39]->end :'' }}" placeholder="截止日" name="end" id="end40">
            </td>
            <td>
            ...
            <td>
              <input name="liable" value="{{ isset($schedule[39]->liable)?$schedule[39]->liable :'' }}" lay-verify="required" placeholder="责任人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
              <input name="check" value="{{ isset($schedule[39]->check)?$schedule[39]->check :'' }}"  lay-verify="required" placeholder="验收人" autocomplete="off" class="layui-input" type="text">
            </td>
            <td>
            <button class="layui-btn layui-btn-sm house_edit" lay-submit="" lay-filter="house_edit">提交</button>
            </td>
